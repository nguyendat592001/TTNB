...
import CoverImage from "@/pages/personal_page/center_avt/center_nav/Modal/cover_image";
import Avatar from "@/pages/personal_page/center_avt/center_nav/Modal/Avatar";
