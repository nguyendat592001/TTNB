                    ...
                    <div className={styles.sukiendoingoai__content__header}>
                        <div className={styles.sukiendoingoai__content__header__left}>
                            <a href="/sukien">
                                ...
                                <span className={styles.sukiendoingoai__content__header__left__text}>
                                    Sự kiện đối ngoại
                                </span>
                            </a>
                        </div>
                    ...
                    <div className={styles.sukiendoingoai__content__body}>
                        <div className={styles.sukiendoingoai__all}>
                            <div className={styles.sukiendoingoai__sapdienra}>
                                <div className={styles.sukiendoingoai__sapdienra__TotalEventTitle}>
                                    <p className={styles.sukiendoingoai__sapdienra__TotalEventTitleText}>Sự kiện sắp diễn ra (1)</p>
                                </div>
                            ...
                            <div className={styles.sukiendoingoai__ketthuc}>
                                <div className={styles.sukiendoingoai__ketthuc__TotalEventTitle}>
                                    <p className={styles.sukiendoingoai__ketthuc__TotalEventTitleText}>Sự kiện đã kết thúc (1)</p>
                                </div>
                                <div className={`${styles.TableEvent} TableEvent`}>
                                    <TableEvent />
                                </div>
