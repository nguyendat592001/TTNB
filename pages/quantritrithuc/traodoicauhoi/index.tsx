...
export default function TraoDoiCauHoi() {
    ...
    const [openModalTurnOnNotification, setOpenModalTurnOnNotification] = useState(false);
    ...
    const sortedData = [...mostKnowledgeableData].sort((a, b) => b.count - a.count);
    const sttArray = sortedData.map((item, index) => ({ ...item, stt: index + 1 }));
                ...
                <div className={`${styles.TDCHContentBody} flex`}>
                    <div className={`${styles.TDCHContentBodyLeft} `}>
                        ...
                        <div className={`${styles.TDCHContentBodyLeftContainer} `}>
                            <div>
                                <div className={`${styles.TDCHContentBodyLeftContentInfo} flex flex-space-between`}>
                                    <div className={`${styles.TDCHContentBodyLeftContentInfoUser} flex `}>
                                        <Image
                                            src="/img/c.png"
                                            alt="Avatar"
                                            width={50}
                                            height={50}
                                            preview={false}
                                            className={styles.TDCHContentBodyLeftContentInfoUserAvatar}
                                        />
                                        <div className={`${styles.TDCHContentBodyLeftContentInfoUserText} `}>
                                            <div className={`${styles.TDCHContentBodyLeftContentInfoUserTextName} flex `}>
                                                <p
                                                    style={{
                                                        fontWeight: 'bold',
                                                        marginRight: '5px',
                                            ...
                                            <div className={`${styles.TDCHContentBodyLeftContentInfoUserTextTime} flex `}>
                                                <p>08:50</p>
                                                <p>04/10/2023</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div className={`${styles.TDCHContentBodyLeftContentOption} cursor-pointer `}>
                                        <Popover
                                ...
                                <div className={`${styles.TDCHContentBodyLeftContentQuestion} `}>
                                    <p>
                                        Hello
                                    </p>
                                ...
                                <div className={`${styles.TDCHContentBodyLeftContentAnswer} flex flex-space-between `}>
                                    <div className={`${styles.TDCHContentBodyLeftContentAnswerLeft} flex cursor-pointer `}>
                                        <Image
                                            src="/img/QTTT/traloi.png"
                                            alt="Avatar"
                                            preview={false}
                                            className={styles.TDCHContentBodyLeftContentAnswerUserAvatar}
                                        />
                                        <p>Trả lời</p>
                                    </div>
                                    <div className={`${styles.TDCHContentBodyLeftContentAnswerRight} flex flex-end `}>
                                        <p>Chưa có câu trả lời</p>
                                    </div>
                                </div>
                                <div className={`${styles.TDCHContentBodyLeftContentComment} flex `}>
                                    <div className={`${styles.TDCHContentBodyLeftContentCommentAvatar} cursor-pointer `}>
                                        <Image
                                            src="/img/c.png"
                                            alt="Avatar"
                                            width={50}
                                            height={50}
                                            preview={false}
                                            className={styles.TDCHContentBodyLeftContentCommentAvatarImg}
                                        />
                                    </div>
                                    <div className={`${styles.TDCHContentBodyLeftContentCommentInput} `}>
                                        <Input
                                ...
                                <div className={`${styles.TDCHContentBodyLeftContentCommentAll} flex `}>
                                    <div className={`${styles.TDCHContentBodyLeftContentCommentList} `}>
                                        <div className={`${styles.TDCHContentBodyLeftContentCommentItem} flex  `}>
                                            <div className={`${styles.TDCHContentBodyLeftContentCommentAvatar} cursor-pointer `}>
                                                <Image
                                                    src="/img/c.png"
                                                    alt="Avatar"
                                                    ...
                                                    height={50}
                                                    preview={false}
                                                    className={styles.TDCHContentBodyLeftContentCommentItemAvatar}
                                                />
                                            </div>
                                            <div style={{
                                                width: '100%',
                                                ...
                                                <div className={`${styles.ContentCommentItem} `}>
                                                    <div className={`${styles.ContentCommentItemInfo} flex flex-space-between `}>
                                                        <div className={`${styles.ContentCommentItemInfoName} flex `}>
                                                            <p
                                                                style={{
                                                                    fontWeight: 'bold',
                                                                }}
                                                        ...
                                                        <div className={`${styles.ContentCommentItemOption} cursor-pointer `}>
                                                            <Popover
                                                                placement="bottomRight"
                                                                arrow={false}
                                                    ...
                                                    <div className={`${styles.ContentCommentItemText} `}>
                                                        <p>
                                                            đây là bình luận fake
                                                        </p>
                                                    </div>

                                                </div>
                                                <div className={`${styles.ContentCommentItemReaction} flex `}>
                                                    <div className={`${styles.ContentCommentItemReactionLike} `}>
                                                        <p className='cursor-pointer'>
                                                            Thích
                                                        </p>
                                                    </div>
                                                    <div className={`${styles.ContentCommentItemReactionReply} `}>
                                                        <p className='cursor-pointer'>
                                                            Trả lời
                                                        </p>
                                                    </div>
