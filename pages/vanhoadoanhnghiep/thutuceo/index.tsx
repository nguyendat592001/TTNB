...
export default function Index() {
    ...
    const childrenContentLeft =
        <div
            className={styles.thutuceoContainer}
        >
            <div
                className={styles.thutuceoContainerHeader}
            >
                <p
                    className={styles.thutuceoContainerTitle}
                >Tạo thư mới từ CEO
                </p>

            </div>
            <div
                className={styles.thutuceoContainerContent}
            >
                <Form
                    name="emailForm"
                    onFinish={onFinish}
                ...
                >
                    ...
                    >
                        <p
                            className={styles.thutuceoContainerContentFormTitle}
                        >Tiêu đề</p>
                        <Input
                    ...
                    >
                        ...
                        >Chọn tệp đính kèm</p>
                        <div
                            className={styles.thutuceoContainerContentFormUpload}
                        >
                            <Upload
                            ...
                            >
                                <Button className={`${styles.UploadContainer} flex cursor-pointer flex-align-center`}>
                    ...
                    >
                        <p
                            className={styles.thutuceoContainerContentFormTitle}
                        >Hình thức thông báo đến nhân viên</p>
                        <div
                            style={{
                                marginBottom: '10px',
                                marginTop: '10px'
    ...
    const childrenContentRight =
        <div className={
            styles.thutuceoContainerContentRight
        }>
            <div
                className={styles.thutuceoContainerContentRightHeader}
            >
                <p>DANH SÁCH THƯ</p>
            </div>
            <div
                className={styles.thutuceoContainerContentRightContent}
            >
                <div
                    className={styles.thutuceoContainerContentRightContentItem}
                >
                    <p
                    ...
                    >
                        <p
                            className={styles.thutuceoContainerContentRightContentItemUser}
                        >Người cập nhật: Công ty Cổ phần Thanh toán Hưng Hà</p>
                        <Image
                    ...
                    <div
                        className={styles.thutuceoContainerContentRightContentItemTimeContainer}
                    >
                        <p
                            className={styles.thutuceoContainerContentRightContentItemTime}
                        >02:49 05.10.2023
                        </p>
                    </div>
                </div>
