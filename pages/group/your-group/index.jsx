...
import { Image, Input, Card, Modal, Select, Upload, Button, message } from "antd";
               ...
               <div className={styles.left_all}>
                  ...
                  <div className={styles.left_allcontent}>
                     <div className={styles.left_content} onClick={() => router.push("/group")}>
                        ...
                        <p className={styles.left_p2}>Trang chủ cộng đồng</p>
                     </div>
            ...
            <div className={styles.right}>
               <div className={styles.right_header}>
                  <div className={styles.img_header}>
                     <Image alt="/" width={1050} height={345} src="/img/group/tq5.jpg" preview={false} />
                  </div>
