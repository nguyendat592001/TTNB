                    ...
                    <div className={styles.celebrateNavbar}>
                        <div className={styles.celebrateAll}>
                            ...
                            <div className={styles.celebrateAllItem}>
                                <Image src="/img/kyniem/all_memory.svg"
                                    width={50}
                                    height={50}
                                    alt="celebrateIcon"
                                    preview={false}
                        ...
                        <div className={styles.celebrateSetting}>
                            ...
                            <div className={styles.celebrateSettingItem}
                                onClick={() => { setIsModalThongBao(true) }}
                            >
                                <Image src="/img/kyniem/memory_notify.svg"
                                    width={50}
                                    height={50}
                                    alt="celebrateIcon"
                                    preview={false}
                            ...
                            <div className={styles.celebrateSettingItem}
                                onClick={() => { setIsModalHideEveryone(true) }}
                            >
                                <Image src="/img/kyniem/memory_hide_all.svg"
                                    width={50}
                                    height={50}
                                    alt="celebrateIcon"
                                    preview={false}
                        ...
                        <div className={styles.centerDetail}>
                            <div className={styles.centerDetailHeader}>
                                ...
                                <div className={styles.centerDetailHeader__content}>
                                    <p>
                                        Chúng tôi hy vọng bạn thích ôn lại và chia sẻ kỷ niệm trên Truyền thông văn hóa,
                                        từ các kỷ niệm gần đây nhất đến những kỷ niệm ngày xa xưa.
                                    </p>
                                </div>
                            </div>
