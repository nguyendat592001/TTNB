            ...
            <div className={styles.modalRegime__container}>
                <div className={styles.modalRegime__content}>
                    <div className={styles.modalRegime__content_title}>
                        <p
                            className={styles.modalRegime__content_mainTitle}
                        >Ai có thể xem bài viết của bạn?</p>
                        <p
                            className={styles.modalRegime__content_subTitle}
                        >Bài viết của bạn sẽ hiển thị ở Bảng tin, trang cá nhân và kết quả tìm kiếm.</p>
                    </div>
                        ...
                        {regimes.map((regime) => (
                            ...
                            >
                                ...
                                <div className={styles.itemTitle}>
                                    <p>{regime.title}</p>
                                    {regime.subtitle && (
                                        <p className={styles.subtitle} onClick={toggleSecondaryModal}>
                                            {regime.subtitle}
                                        </p>
                                    )}
                                </div>
                                {regime.subtitle && (
                                    <p className={styles.subIcon} onClick={toggleSecondaryModal}>
                                        <RightOutlined style={{ marginRight: '8px' }} rev={undefined} />
                                    </p>
                                )}
