...
export default function QTTT() {
    ...
    const [isExchangeQuestionModalOpen, setIsExchangeQuestionModalOpen] = useState(false);
                ...
                >
                    ...
                    >
                        <Image
                            ...
                            preview={false}
                        />
                        <span className={styles.themtailieuButtonText}>Thêm tài liệu</span>
                    </Button>
                </div>
